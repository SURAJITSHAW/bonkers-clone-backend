...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE category SET category_name='$nameUpper', slug='$nameLower' WHERE category_id='$id'";
            ...
            <div id="content">
                ...
                ?>
                        ...
                        <form class="post-form" action="" method="post">
                            ...
                            <p>Category Name</p>
                            <input required type="text" name="name" value='<?php echo $row["category_name"]; ?>' />

                            <p><input required class="submit btn btn-success" name="submit" type="submit" value="Update Category" /></p>
                        </form>
                <?php
                    }
                } else {
