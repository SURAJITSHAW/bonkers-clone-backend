...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE subcategory SET name='$nameUpper', slug='$nameLower', category_id='$category_id' WHERE id='$id'";
            ...
            <div id="content">
                ...
                ?>
                        ...
                        <form class="post-form" action="" method="post">
                            ...
                            <p><input required class="submit btn btn-success" name="submit" type="submit" value="Edit Sub Category" /></p>
                        </form>
                <?php
                    }
                } else {
