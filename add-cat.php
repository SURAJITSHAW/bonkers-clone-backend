...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO category(category_name, slug) VALUES ('$nameUpper', '$nameLower' )";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form class="post-form" action="" method="post" >
                    ...
                    <p><input required class="submit btn btn-success" name="submit" type="submit" value="Add Category" /></p>
                </form>
